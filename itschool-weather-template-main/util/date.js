...
function getDayOfTheWeek(dateInUtc){
    // Pentru ca data de la API e in UTC format -trebuie sa o transform folosind obiectul Date din JS
...
function getHours(dateInUtc) {
    ...
    // Extragem minutele folosind o metoda de pe Date() = getMinutes();
